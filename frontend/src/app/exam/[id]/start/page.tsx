...
export default function ExamPage() {
    ...
    return (
        <div className="min-h-screen bg-gray-100 font-sans flex flex-col">
            {/* Top Header */}
            <header className="bg-white shadow-sm px-3 sm:px-6 py-2 sm:py-3 flex justify-between items-center sticky top-0 z-30 h-14 sm:h-16">
                ...
                <div className="flex items-center gap-2 sm:gap-4 flex-shrink-0">
                    <div className={`flex items-center gap-1 sm:gap-2 px-2 sm:px-3 py-1 sm:py-1.5 rounded-md font-mono font-bold text-sm sm:text-lg border ${examTimerService.isTimeCritical(remainingSeconds)
                        ? "bg-red-50 text-red-600 border-red-200"
                        : "bg-blue-50 text-blue-600 border-blue-200"
                        }`}>
                        <span className="hidden sm:inline">⏱️</span>
                        <span className="text-xs sm:text-base">{examTimerService.formatTime(remainingSeconds)}</span>
                    </div>
                </div>
            </header>

            {/* Main Layout */}
            <div className="flex-1 flex flex-col lg:flex-row overflow-hidden max-w-[1600px] mx-auto w-full p-2 sm:p-4 gap-4">
                ...
                <main className="flex-1 flex flex-col min-w-0 bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                        ...
                        {sections.map((section) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`px-3 sm:px-6 py-2 sm:py-3 text-xs sm:text-sm font-semibold whitespace-nowrap transition-all relative min-w-fit ${activeSection === section
                                        ? "text-blue-600 bg-white"
                                        : "text-gray-600 hover:text-gray-800 hover:bg-gray-100"
                                        }`}
                                >
                                    <div className="flex flex-col items-start gap-1 sm:gap-1.5">
                                        <span className="text-xs sm:text-sm">{section}</span>
                                ...
                                <div className="mb-8 flex justify-center">
                                    <img
                                        ...
                                        onError={(e) => {
                                            ...
                                            console.error('Failed to load diagram:', currentQuestion.diagram_url);
                                        }}
                                    />
                                </div>
                            )}
                    ...
                    <div className="p-3 sm:p-4 border-t border-gray-200 bg-white flex justify-between items-center gap-2">
                        <button
                            ...
                            className="px-4 sm:px-6 py-2 rounded-full border border-gray-300 text-gray-600 text-sm sm:text-base font-medium hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            Previous
                        </button>
                        ...
                        <div className="flex gap-2 sm:gap-3">
                            <button
                                onClick={handleMarkForReview}
                                className={`px-3 sm:px-6 py-2 rounded-full text-sm sm:text-base font-medium transition-colors ${markedForReview.has(currentQuestion.id)
                                    ? "bg-yellow-100 text-yellow-700 border border-yellow-200"
                                    : "bg-yellow-400 hover:bg-yellow-500 text-white shadow-sm"
                                    }`}
                            >
                                <span className="hidden sm:inline">{markedForReview.has(currentQuestion.id) ? "Unmark Review" : "Mark for Review"}</span>
                            ...
                            <button
                                ...
                                className="px-4 sm:px-8 py-2 rounded-full bg-gray-900 hover:bg-gray-800 text-white text-sm sm:text-base font-medium shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                Save & Next
                            </button>
                        </div>
            ...
            {showMobilePalette && (
                <div className="lg:hidden fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-end sm:items-center justify-center p-0 sm:p-4">
                    <div className="bg-white w-full sm:max-w-md sm:rounded-2xl rounded-t-3xl shadow-2xl max-h-[90vh] flex flex-col animate-in slide-in-from-bottom duration-300">
                        {/* Header */}
                        ...
                        <div className="flex-1 overflow-y-auto p-4">
                            <h4 className="font-bold text-gray-800 mb-3 text-sm">Questions</h4>
                        ...
                        <div className="p-4 border-t border-gray-200 space-y-2">
                            <button
                                ...
                                className="w-full py-3 bg-gray-700 hover:bg-gray-800 text-white font-bold rounded-xl transition-colors"
                            >
                                📋 Review Answers
                            </button>
                            <button
